...
if not os.environ.get("JAVA_HOME"):
    ...
    # Ordem de deteção: Linux/Mac moderno → Linux/Mac legado → Windows
    if os.path.exists(os.path.join(conda_prefix, "bin", "java")):
        os.environ["JAVA_HOME"] = conda_prefix                              # Linux/Mac (openjdk moderno)
    elif os.path.exists(os.path.join(conda_prefix, "lib", "jvm", "bin", "java")):
        os.environ["JAVA_HOME"] = os.path.join(conda_prefix, "lib", "jvm") # Linux/Mac legado
    elif os.path.exists(os.path.join(conda_prefix, "Library", "bin", "java.exe")):
        os.environ["JAVA_HOME"] = os.path.join(conda_prefix, "Library")     # Windows
